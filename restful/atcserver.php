...
if($p == "add"){
    ...
    $parms = "?action = add&title = ".$title." type = ".$type."content = ".$content."";
}
elseif($p == "del"){
    $title = $_POST['title'];
    $parms = "?action = del&title = ".$title." ";
}
elseif ($p == "edi"){
    $title = $_POST['title'];
    $type = $_POST['type'];
    $content = $_POST['content'];
    $parms = "?action = edi&title = ".$title." type = ".$type."content = ".$content."";
}
elseif($p == "sea"){
    $title = $_POST['title'];
    $type = $_POST['type'];
    $content = $_POST['content'];
    $parms = "?action = sea&title = ".$title." ";
}
